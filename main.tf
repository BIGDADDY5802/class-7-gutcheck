...
resource "aws_s3_bucket" "deliverables" {
  bucket_prefix = "class-7-gutcheck-"
  force_destroy = true

  tags = {
    Name    = "class-7-gutcheck-deliverables"
    Purpose = "G-Check submission deliverables"
  }
}
...
resource "aws_s3_object" "readme" {
  ...
  content = <<-EOF
    ...
    ## Repo
    https://github.com/BIGDADDY5802/armageddon_deliverables/tree/main/lab-3
    https://github.com/BIGDADDY5802/class-7-gutcheck
